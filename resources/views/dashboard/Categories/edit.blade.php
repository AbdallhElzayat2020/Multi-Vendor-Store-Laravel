        ...
        <form class="row g-4" action="{{ route('dashboard.categories.update', $category->id) }}" method="post"
            ...
            <div class="col-md-6">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" value="active" @checked($category->status == 'active')
                        name="status" id="active" checked>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" value="archived" name="status"
                        @checked($category->status == 'archived') id="archived">
            ...
            <div class="col-md-12">
                ...
                <textarea type="text" name="description" class="form-control" placeholder="Category Description">{{ $category->description }}
                </textarea>
            </div>
